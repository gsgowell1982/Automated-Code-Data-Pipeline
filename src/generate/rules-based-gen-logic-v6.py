...
class HybridQAOrchestrator:
    ...
    def print_summary(self):
        ...
        print(f"  - Code-name-free Questions: {code_name_free}/{len(self.generated_pairs)} ({100*code_name_free/max(1,len(self.generated_pairs)):.0f}%)")
    ...
    def print_sample_pairs(self, n: int = 3):
        ...
        for i, pair in enumerate(samples):
            ...
            print(f"[Sample {i+1}] Source: {meta.get('question_source', 'N/A')} | Role: {meta.get('user_role', 'N/A')}")
            print("=" * 70)
